...
Pod::Spec.new do |s|
    ...
    s.source       = { :git => "https://github.com/CPaaSAPI/CpaaSAPIVOICE.git", :tag => "#{s.version}"}
    ...
    s.dependency 'CpaaSAPIAWSMobileClient_iOS', '~> 0.2.0'
    s.dependency 'CpaaSAPIWebRTCFramework_iOS', '~> 0.3.0'
end
